...
const Bio = () => {
  return (
    <Container maxWidth="lg">
      <Typography variant="h3" className={bioStyles.sectionHeading}>
        About Me
      </Typography>
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6} md={3}>
          <Avatar src={aboutImage} className={bioStyles.profile} />
        </Grid>
        <Grid item xs={12} sm={6} md={9}>
          ...
          <Typography variant="body1">
            ...
            <br />
            <br />
            Over the course of my life and career I have developed expertise in
            several areas of web development and design. I am seeking to
            continue this growth by opening myself for opportunities which are
            guaranteed to challenge me.
            <br />
            <br />
            You can review my latest work in my Portfolio and read more about my
            biography, experience, skills, education and much more in my Resume.
          </Typography>
        </Grid>
      </Grid>
    </Container>
